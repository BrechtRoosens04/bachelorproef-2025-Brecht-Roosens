...
\title%
    {Met Machine Learning een methodiek maken ter ondersteuning van het onderhoudsbeleid van bouwmachines in kleine bouwondernemingen}
...
\input{databeschikbaarheid}

\input{deechtedata}

\input{deopenbaredata}

\input{deonderzochteanomaliemodellen}
