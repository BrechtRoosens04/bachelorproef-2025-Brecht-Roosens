...
In dit onderzoek wordt de One-Class SVM-model gebruikt als een klassiek unsupervised model voor het detecteren van anomalieën. Het model wordt eerst beoordeeld op basis van de opnebare MetroPT-3-dataset en daarna geïmplementeerd op de private tractordataset. De uitkomsten worden vergeleken met die van Random Forest-model, Autoencoder en LSTM Autoencoder om te bepalen welke methode het beste werkt voor het opsporen van afwijkingen in sensorgegevens en het ondersteunen van het onderhoudsbeleid voor bouwmachines in kleine bouwbedrijven.
